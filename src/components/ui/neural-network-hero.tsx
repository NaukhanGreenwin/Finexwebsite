...
function ShaderBackground() {
  ...
  return (
    <div ref={canvasRef} className="bg-black absolute inset-0 -z-10 w-full h-full" aria-hidden>
      ...
      {/* Neural Network Shader Overlay */}
      <div className="absolute inset-0 w-full h-full opacity-20 mix-blend-soft-light z-10">
        <Canvas
          camera={camera}
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-black/20 z-20" />
    </div>
  );
}
...
export default function Hero({
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-36 sm:gap-8 sm:pt-44 md:px-10 lg:px-16 z-30">
